    ...
    <div class="row flex-row flex-sm-nowrap py-3">
        ...
        <div class="col-sm-6 col-md-4 col-xl-4">
            <div class="card" style="background-color: #86B5B3; color: black">
                <div class="card-body">
                    <a class="rounded-circle float-right" href="{{ route('createTask')}}" style="color: black">
                    ...
                    <div class="items border-light">
                        <div class="card draggable shadow-sm" id="cd1" draggable="true" ondragstart="drag(event)">
                            <div class="card-body p-2" style="background-color: white; border-radius: 10px">
                                ...
                                <a class="btn btn-sm" href="{{ route('viewTask', $datatodo->id) }}" style="background-color: #145956; color: white">View</a>
                            </div>
                        </div>
                    ...
                    <div class="items border-light">
                        <div class="card draggable shadow-sm" id="cd1" draggable="true" ondragstart="drag(event)">
                            <div class="card-body p-2" style="background-color: white; border-radius: 10px">
                                ...
                                <a class="btn btn-sm" href="{{ route('viewTask', $datadoing->id) }}" style="background-color: #145956; color: white">View</a>
                            </div>
                        </div>
                        <div class="dropzone rounded" ondrop="drop(event)" ondragover="allowDrop(event)" ondragleave="clearDrop(event)"> &nbsp; </div>
                    ...
                    <div class="items border-light">
                        <div class="card draggable shadow-sm" id="cd1" draggable="true" ondragstart="drag(event)">
                            <div class="card-body p-2" style="background-color: white; border-radius: 10px">
                                ...
                                <a class="btn btn-sm" href="{{ route('viewTask', $datadone->id) }}" style="background-color: #145956; color: white">View</a>
                            </div>
                        </div>
                        <div class="dropzone rounded" ondrop="drop(event)" ondragover="allowDrop(event)" ondragleave="clearDrop(event)"> &nbsp; </div>
