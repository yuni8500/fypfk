            ...
            <div class="col-lg-16 col-md-12 col-sm-12">
                <nav class="">
                    <ul class="nav nav-tabs" id="myTab" role="tablist" style="color: black">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('evaluationRecordPTA1') ? 'active' : '' }}" href="{{ route('evaluationRecordPTA1') }}" role="tab" aria-selected="true">PTA 1</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('evaluationRecordPSM1') ? '' : '' }}" href="{{ route('evaluationRecordPSM1') }}" role="tab" aria-selected="true">PSM 1</a>
                        </li>
                        <li class="nav-item">
